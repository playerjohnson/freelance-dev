...
// Navigation runs as soon as its markup exists, before the main content is parsed.
// The contact form is later in the document, so wait until its fields exist.
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initialiseContactForm, { once: true });
} else {
